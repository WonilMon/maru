...
<body data-path-to-root="/" data-include-products="false"
					...
					<div class="u-layout-row">
						<div
							...
							<div
								...
								<h2 class="u-align-center-sm u-align-center-xs u-text u-text-1">About
									Collaboration</h2>
								<p class="u-align-center-sm u-align-center-xs u-text u-text-2">Podcasting
									operational change management inside of workflows to establish
									a framework. Taking seamless key performance indicators offline
									to maximise the long tail. Keeping your eye on the ball while
	...
	<section class="u-align-center u-clearfix u-palette-1-base u-section-2"
		...
		<div class="u-clearfix u-sheet u-valign-middle u-sheet-1">
			...
			<h2 class="u-text u-text-1">About Frameworks</h2>
			<p class="u-text u-text-2">Iterative approaches to corporate
				...
				<div class="u-repeater u-repeater-1">
					<div
						...
						<div
							...
							<p class="u-align-center-sm u-align-center-xs u-text u-text-1">Sample
								text. Click to select the text box. Click again or double click
								to start editing the text.&nbsp;Duis aute irure dolor in
					...
					<div
						...
						<div
							...
							<p class="u-align-center-sm u-align-center-xs u-text u-text-2">Sample
								text. Click to select the text box. Click again or double click
								to start editing the text.&nbsp;Duis aute irure dolor in
								reprehenderit in voluptate velit esse cillum dolore eu fugiat
								nulla pariatur.</p>
					...
					<div
						...
						<div
							...
							<p class="u-align-center-sm u-align-center-xs u-text u-text-3">Sample
								text. Click to select the text box. Click again or double click
								to start editing the text.&nbsp;Duis aute irure dolor in
								reprehenderit in voluptate velit esse cillum dolore eu fugiat
								nulla pariatur.</p>
					...
					<div
						...
						<div
							...
							<p class="u-align-center-sm u-align-center-xs u-text u-text-4">Sample
								text. Click to select the text box. Click again or double click
								to start editing the text.&nbsp;Duis aute irure dolor in
								reprehenderit in voluptate velit esse cillum dolore eu fugiat
								nulla pariatur.</p>
