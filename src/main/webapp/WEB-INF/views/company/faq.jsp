			...
			<div
				...
				<div class="u-accordion-item">
					<a
						...
						aria-selected="true"> <span class="u-accordion-link-text">What's
							included in the quoted daily rate?</span><span
	...
	c0.4-0.4,0.4-0.9,0-1.3c-0.4-0.4-1-0.4-1.3,0L8,10.7z"></path></svg></span>
					...
					<div
						...
						<div class="u-container-layout u-container-layout-1">
							<div class="fr-view u-clearfix u-rich-text u-text">
								<p>Answer. Lorem ipsum dolor sit amet, consectetur
									adipiscing elit. Curabitur id suscipit ex. Suspendisse rhoncus
									laoreet purus quis elementum. Phasellus sed efficitur dolor, et
									ultricies sapien. Quisque fringilla sit amet dolor commodo
									efficitur. Aliquam et sem odio. In ullamcorper nisi nunc, et
									molestie ipsum iaculis sit amet.</p>
							</div>
						</div>
					</div>
				</div>
				<div class="u-accordion-item">
					<a
						...
						aria-selected="false"> <span class="u-accordion-link-text">What
							is the rental's mileage plan?</span><span
	...
	c0.4-0.4,0.4-0.9,0-1.3c-0.4-0.4-1-0.4-1.3,0L8,10.7z"></path></svg></span>
				...
				<div class="u-accordion-item">
					<a
						...
						aria-selected="false"> <span class="u-accordion-link-text">What
							are your extra insurance options?</span><span
	...
	c0.4-0.4,0.4-0.9,0-1.3c-0.4-0.4-1-0.4-1.3,0L8,10.7z"></path></svg></span>
				...
				<div class="u-accordion-item u-expanded-width">
					<a
						...
						id="link-accordion-eb1f" aria-controls="accordion-eb1f"
						aria-selected="false"> <span class="u-accordion-link-text">Do
							I need to return the rental with a full tank?</span><span
	...
	<section class="u-align-center u-clearfix u-section-3" id="sec-72bd">
		<div class="u-clearfix u-sheet u-valign-middle u-sheet-1">
			...
			<div class="u-form u-form-1">
				<form:form modelAttribute="faqBean"
					action="${root }company/faq_pro"
					class="u-clearfix u-form-spacing-10 u-form-vertical u-inner-form"
					style="padding: 10px">
					<div class="u-form-email u-form-group u-label-none">
						<form:label path="faq_user_email" class="u-label">Email</form:label>
						<form:input type="email" placeholder="Enter a valid email address"
							path="faq_user_email" class="u-input u-input-rectangle" />
					</div>
					<div class="u-form-group u-form-message u-label-none">
						<form:label path="faq_user_text" class="u-label">Message</form:label>
						<form:textarea placeholder="Enter your message" rows="4" cols="50"
							path="faq_user_text" class="u-input u-input-rectangle"></form:textarea>
					</div>
					<div class="u-align-left u-form-group u-form-submit">
						<button type="button" class="u-btn u-btn-submit u-button-style">Submit</button>
					</div>
				</form:form>
			</div>
		</div>
