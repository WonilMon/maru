		...
		<form:form action="${root}board/board_modify_pro"
			...
			<div class="form-footer">
				<form:button type="submit"
					style="padding: 10px 20px; background-color: #E5989B; color: white; border: none; border-radius: 5px; margin-right: 30px;">投稿</form:button>
				<a href="${root }board/board_delete?board_info_idx=${board_info_idx}&content_idx=${content_idx}"
					style="padding: 10px 20px; background-color: #D8E2DC; color: #6D6875; text-decoration: none; border-radius: 5px; margin-right: 30px;">削除</a>
				<a href="${root }board/board_read?board_info_idx=${board_info_idx}&content_idx=${content_idx}"
					style="padding: 10px 20px; background-color: #FFCDB2; color: #6D6875; text-decoration: none; border-radius: 5px; margin-right: 30px;">目録</a>
			</div>
		</form:form>
	</section>
