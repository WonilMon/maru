...
<link rel="stylesheet" href="${root }css/SearchPassword.css" media="screen">
...
<meta name="twitter:title" content="SearchPassword">
<meta name="twitter:description" content="Site1">
<meta property="og:title" content="SearchPassword">
		...
		<div class="u-clearfix u-sheet u-valign-middle u-sheet-1">
			<div
				...
				<div class="u-container-layout u-container-layout-1">
					<h1 class="u-align-center u-text u-text-default u-text-1">SearchPassword</h1>
					...
					<div class="u-form u-form-1">
						<form action="https://forms.nicepagesrv.com/v2/form/process"
							...
							<div
								class="u-form-email u-form-group u-label-none u-form-group-1">
								<label class="u-label u-label-1">Email</label> <input
									type="email" placeholder="Enter a valid email address"
									id="email-7816" name="email" class="u-input u-input-rectangle"
									required="">
							</div>
							<div class="u-form-group u-label-none u-form-group-2">
								<label class="u-label u-label-2">Input</label> <input
									type="text" id="text-85d3" name="text"
									class="u-input u-input-rectangle" placeholder="Authentication">
							</div>
							<div
