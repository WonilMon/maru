...
<meta
	...
	name="viewport">
<title>Profile | Bootstrap Based Admin Template - Material
	Design</title>
<!-- Favicon-->
			...
			<div class="menu">
				<ul class="list">
					...
					<li class="active"><a href="javascript:void(0);"
						...
						<ul class="ml-menu">
							<li class="active"><a
								href="../../pages/examples/profile.html">Profile</a></li>
						...
						<div class="body">
							<ul>
								...
								<li>
									...
									<div class="content">Malibu, California</div>
								</li>
								<li>
									<div class="title">
											...
											<div class="panel-heading">
												<div class="media">
													<div class="media-left">
														<a href="#"> <img src="../../images/user-lg.jpg" />
														</a>
													</div>
													...
													<div class="post-heading">
														<p>
															I am a very simple wall post. I am good at containing <a
																href="#">#small</a> bits of <a href="#">#information</a>.
															I require little more information to use effectively.
														</p>
													</div>
													<div class="post-content">
														<img src="../../images/profile-post-image.jpg"
