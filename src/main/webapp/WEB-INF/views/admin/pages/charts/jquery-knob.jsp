...
<meta
	...
	name="viewport">
<title>Jquery Knob | Bootstrap Based Admin Template - Material
	Design</title>
<!-- Favicon-->
				...
				<ul class="list">
					...
					<li class="active"><a href="javascript:void(0);"
						...
						<ul class="ml-menu">
							...
							<li class="active"><a
								href="../../pages/charts/jquery-knob.html">Jquery Knob</a></li>
						</ul></li>
					<li><a href="javascript:void(0);" class="menu-toggle"> <i
	...
	<section class="content">
		<div class="container-fluid">
			<div class="block-header">
				<h2>
					JQUERY KNOB <small>Taken from <a
						href="https://github.com/aterrien/jQuery-Knob" target="_blank">github.com/aterrien/jQuery-Knob</a></small>
				</h2>
			</div>
				...
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					<div class="card">
						...
						<div class="body">
							<div class="row clearfix">
								<div class="col-md-2">
									<input type="text" class="knob" value="86" data-width="125"
										data-height="125" data-thickness="0.25" data-fgColor="#F44336">
								</div>
								<div class="col-md-2">
									<input type="text" class="knob" value="92" data-width="125"
										data-height="125" data-thickness="0.25" data-fgColor="#E91E63">
								</div>
								<div class="col-md-2">
									<input type="text" class="knob" value="93" data-width="125"
										data-height="125" data-thickness="0.25" data-fgColor="#00BCD4">
								</div>
								<div class="col-md-2">
									<input type="text" class="knob" value="89" data-width="125"
										data-height="125" data-thickness="0.25" data-fgColor="#009688">
								</div>
								<div class="col-md-2">
									<input type="text" class="knob" value="91" data-width="125"
				...
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					<div class="card">
						...
						<div class="body">
							<div class="row clearfix">
								<div class="col-md-2">
									<input type="text" class="knob" data-linecap="round" value="42"
										data-width="125" data-height="125" data-thickness="0.25"
										data-fgColor="#F44336">
								</div>
								<div class="col-md-2">
									<input type="text" class="knob" data-linecap="round" value="56"
										data-width="125" data-height="125" data-thickness="0.25"
										data-fgColor="#E91E63">
								</div>
								<div class="col-md-2">
									<input type="text" class="knob" data-linecap="round" value="48"
										data-width="125" data-height="125" data-thickness="0.25"
										data-fgColor="#00BCD4">
								</div>
								<div class="col-md-2">
									<input type="text" class="knob" data-linecap="round" value="65"
										data-width="125" data-height="125" data-thickness="0.25"
										data-fgColor="#009688">
								</div>
								<div class="col-md-2">
									<input type="text" class="knob" data-linecap="round" value="72"
										data-width="125" data-height="125" data-thickness="0.25"
										data-fgColor="#FF9800">
								</div>
								<div class="col-md-2">
									<input type="text" class="knob" data-linecap="round" value="18"
										data-width="125" data-height="125" data-thickness="0.25"
										data-fgColor="#9C27B0">
								</div>
							</div>
				...
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					<div class="card">
						...
						<div class="body">
							<div class="row clearfix">
								<div class="col-md-2">
									<input type="text" class="knob" value="86" data-width="90"
										data-height="90" data-thickness="0.1" data-fgColor="#F44336">
								</div>
								<div class="col-md-2">
									<input type="text" class="knob" value="92" data-width="120"
										data-height="120" data-thickness="0.32" data-fgColor="#E91E63">
								</div>
								<div class="col-md-2">
									<input type="text" class="knob" value="93" data-width="120"
										data-height="120" data-thickness="0.50" data-fgColor="#00BCD4">
								</div>
								<div class="col-md-2">
									<input type="text" class="knob" value="89" data-width="80"
										data-height="80" data-thickness="0.16" data-fgColor="#009688">
								</div>
								<div class="col-md-2">
									<input type="text" class="knob" value="91" data-width="75"
										data-height="75" data-thickness="0.2" data-fgColor="#FF9800">
								</div>
								<div class="col-md-2">
									<input type="text" class="knob" value="93" data-width="120"
										data-height="120" data-thickness="0.12" data-fgColor="#9C27B0">
								</div>
							</div>
						</div>
					</div>
				...
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					<div class="card">
						...
						<div class="body">
							<div class="row clearfix">
								<div class="col-md-2">
									<input type="text" class="knob" value="35" data-width="125"
										data-height="125" data-thickness="0.25" data-angleArc="250"
										data-angleoffset="-125" data-fgColor="#F44336">
								</div>
								<div class="col-md-2">
									<input type="text" class="knob" value="45" data-width="125"
										data-height="125" data-thickness="0.25" data-angleArc="250"
										data-angleoffset="-305" data-fgColor="#E91E63">
								</div>
								<div class="col-md-2">
									<input type="text" class="knob" value="40" data-width="125"
										data-height="125" data-thickness="0.25" data-angleArc="250"
										data-angleoffset="-35" data-fgColor="#00BCD4">
								</div>
								<div class="col-md-2">
									<input type="text" class="knob" value="36" data-width="125"
										data-height="125" data-thickness="0.25" data-angleArc="250"
										data-angleoffset="145" data-fgColor="#009688">
								</div>
								<div class="col-md-2">
									<input type="text" class="knob" value="43" data-width="125"
										data-height="125" data-thickness="0.25" data-angleArc="270"
										data-angleoffset="-0" data-fgColor="#FF9800">
								</div>
								<div class="col-md-2">
									<input type="text" class="knob" value="52" data-width="125"
										data-height="125" data-thickness="0.25" data-angleArc="270"
										data-angleoffset="90" data-fgColor="#9C27B0">
								</div>
							</div>
						</div>
					</div>
				...
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					<div class="card">
						...
						<div class="body">
							<div class="row clearfix">
								<div class="col-md-2">
									<input type="text" class="knob" value="42" data-width="125"
										data-height="125" data-thickness="0.25" data-fgColor="#F44336"
										readonly>
								</div>
								<div class="col-md-2">
									<input type="text" class="knob" value="56" data-width="125"
										data-height="125" data-thickness="0.25" data-fgColor="#E91E63"
										readonly>
								</div>
								<div class="col-md-2">
									<input type="text" class="knob" value="48" data-width="125"
										data-height="125" data-thickness="0.25" data-fgColor="#00BCD4"
										readonly>
								</div>
								<div class="col-md-2">
									<input type="text" class="knob" value="65" data-width="125"
										data-height="125" data-thickness="0.25" data-fgColor="#009688"
										readonly>
								</div>
								<div class="col-md-2">
									<input type="text" class="knob" value="72" data-width="140"
										data-height="140" data-thickness="0.20" data-fgColor="#FF9800"
										data-skin="tron" readonly>
								</div>
								<div class="col-md-2">
									<input type="text" class="knob" value="18" data-width="125"
										data-height="125" data-thickness="0.25" data-fgColor="#9C27B0"
				...
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					<div class="card">
						...
						<div class="body">
							<div class="row clearfix">
								<div class="col-md-2">
									<input type="text" class="knob" data-skin="tron" value="45"
										data-width="135" data-height="135" data-thickness="0.2"
										data-fgColor="#F44336">
								</div>
								<div class="col-md-2">
									<input type="text" class="knob" data-skin="tron" value="58"
										data-width="135" data-height="135" data-thickness="0.2"
										data-fgColor="#E91E63">
								</div>
								<div class="col-md-2">
								...
								<div class="col-md-2">
									<input type="text" class="knob" data-skin="tron" value="42"
										data-width="135" data-height="135" data-thickness="0.2"
										data-fgColor="#009688">
								</div>
								<div class="col-md-2">
									<input type="text" class="knob" data-skin="tron" value="100"
										data-width="135" data-height="135" data-thickness="0.2"
										data-angleArc="270" data-angleoffset="90"
										data-fgColor="#FF9800">
								</div>
								<div class="col-md-2">
									<input type="text" class="knob" data-skin="tron" value="100"
