				...
				<ul class="list">
					...
					<li class="active"><a href="javascript:void(0);"
						...
						<ul class="ml-menu">
							...
							<li class="active"><a href="../../pages/charts/flot.html">Flot</a>
							</li>
	...
	<section class="content">
		<div class="container-fluid">
			<div class="block-header">
				<h2>
					FLOT CHART <small>Taken from <a
						href="http://www.flotcharts.org" target="_blank">www.flotcharts.org</a></small>
				</h2>
			</div>
