			...
			<div class="menu">
				<ul class="list">
					...
					<li class="active"><a href="javascript:void(0);"
						...
						<ul class="ml-menu">
							<li class="active"><a href="../../pages/charts/morris.html">Morris</a>
							</li>
	...
	<section class="content">
		<div class="container-fluid">
			<div class="block-header">
				<h2>
					MORRIS <small>Taken from <a
						href="https://github.com/morrisjs/morris.js" target="_blank">github.com/morrisjs/morris.js</a></small>
				</h2>
			</div>
