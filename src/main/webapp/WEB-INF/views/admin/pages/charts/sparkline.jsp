...
<meta
	...
	name="viewport">
<title>Sparkline | Bootstrap Based Admin Template - Material
	Design</title>
<!-- Favicon-->
	...
	<section class="content">
		<div class="container-fluid">
			<div class="block-header">
				<h2>
					SPARKLINE CHART <small>Taken from <a
						href="http://omnipotent.net/jquery.sparkline" target="_blank">omnipotent.net/jquery.sparkline</a></small>
				</h2>
			</div>
					...
					<div class="card">
						...
						<div class="body">
							<div class="sparkline" data-type="line" data-spot-Radius="3"
								...
								data-max-Spot-Color="rgb(0, 150, 136)"
								data-spot-Color="rgb(0, 188, 212)" data-offset="90"
								data-width="100%" data-height="150px" data-line-Width="2"
								data-line-Color="rgb(0, 188, 212)"
					...
					<div class="card">
						...
						<div class="body">
							<div class="sparkline" data-type="bar" data-width="97%"
								data-height="150px" data-bar-Width="16" data-bar-Spacing="7"
								data-bar-Color="rgb(0, 188, 212)">
						...
						<div class="body">
							<div class="row clearfix">
								...
								<div class="col-sm-6">
									...
									<p>
										<span class="sparkpie">1,1,2</span> <span class="sparkpie">1,5</span>
