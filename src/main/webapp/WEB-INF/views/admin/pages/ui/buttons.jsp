...
<meta
	...
	name="viewport">
<title>Buttons | Bootstrap Based Admin Template - Material
	Design</title>
<!-- Favicon-->
...
<body class="theme-red">
				...
				<ul class="list">
					...
					<li class="active"><a href="javascript:void(0);"
						...
						<ul class="ml-menu">
							...
							<li class="active"><a href="../../pages/ui/buttons.html">Buttons</a>
							</li>
	...
	<section class="content">
		<div class="container-fluid">
			...
			<div class="row">
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					<div class="card">
						<div class="header">
							<h2>
								BOOTSTRAP DEFAULT BUTTONS <small>Use any of the
									available button classes to quickly create a styled button</small>
							</h2>
			...
			<div class="row">
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					<div class="card">
						<div class="header">
							<h2>
								METARIAL DESIGN BUTTONS <small>Use any of the available
									button classes to quickly create a styled button</small>
							</h2>
							<ul class="header-dropdown m-r--5">
								<li class="dropdown"><a href="javascript:void(0);"
									class="dropdown-toggle" data-toggle="dropdown" role="button"
						...
						<div class="body">
							<div class="button-demo">
								...
								<button type="button" class="btn bg-deep-purple waves-effect">DEEP
									PURPLE</button>
								...
								<button type="button" class="btn bg-light-blue waves-effect">LIGHT
									BLUE</button>
								...
								<button type="button" class="btn bg-light-green waves-effect">LIGHT
									GREEN</button>
								...
								<button type="button" class="btn bg-deep-orange waves-effect">DEEP
									ORANGE</button>
								...
								<button type="button" class="btn bg-blue-grey waves-effect">BLUE
									GREY</button>
								<button type="button"
									class="btn bg-black waves-effect waves-light">BLACK</button>
							</div>
						</div>
					</div>
				</div>
			...
			<div class="row">
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					<div class="card">
						<div class="header">
							<h2>
								BUTTON SIZES <small>You can resize the buttons</small>
							</h2>
							<ul class="header-dropdown m-r--5">
								<li class="dropdown"><a href="javascript:void(0);"
									class="dropdown-toggle" data-toggle="dropdown" role="button"
						...
						<div class="body">
							<div class="row clearfix demo-button-sizes">
								<div class="col-xs-6 col-sm-3 col-md-2 col-lg-2">
									<button type="button"
										class="btn bg-red btn-block btn-lg waves-effect">LARGE</button>
									<button type="button" class="btn bg-red btn-block waves-effect">DEFAULT</button>
									<button type="button"
										class="btn bg-red btn-block btn-sm waves-effect">SMALL</button>
									<button type="button"
										class="btn bg-red btn-block btn-xs waves-effect">EXTRA
										SMALL</button>
								</div>
								<div class="col-xs-6 col-sm-3 col-md-2 col-lg-2">
									<button type="button"
										class="btn bg-pink btn-block btn-lg waves-effect">LARGE</button>
									<button type="button"
										class="btn bg-pink btn-block waves-effect">DEFAULT</button>
									<button type="button"
										class="btn bg-pink btn-block btn-sm waves-effect">SMALL</button>
									<button type="button"
										class="btn bg-pink btn-block btn-xs waves-effect">EXTRA
										SMALL</button>
								</div>
								<div class="col-xs-6 col-sm-3 col-md-2 col-lg-2">
									<button type="button"
										class="btn bg-cyan btn-block btn-lg waves-effect">LARGE</button>
									<button type="button"
										class="btn bg-cyan btn-block waves-effect">DEFAULT</button>
									<button type="button"
										class="btn bg-cyan btn-block btn-sm waves-effect">SMALL</button>
									<button type="button"
										class="btn bg-cyan btn-block btn-xs waves-effect">EXTRA
										SMALL</button>
								</div>
								<div class="col-xs-6 col-sm-3 col-md-2 col-lg-2">
									<button type="button"
										class="btn bg-teal btn-block btn-lg waves-effect">LARGE</button>
									<button type="button"
										class="btn bg-teal btn-block waves-effect">DEFAULT</button>
									<button type="button"
										class="btn bg-teal btn-block btn-sm waves-effect">SMALL</button>
									<button type="button"
										class="btn bg-teal btn-block btn-xs waves-effect">EXTRA
										SMALL</button>
								</div>
								<div class="col-xs-6 col-sm-3 col-md-2 col-lg-2">
									<button type="button"
										class="btn bg-orange btn-block btn-lg waves-effect">LARGE</button>
									<button type="button"
										class="btn bg-orange btn-block waves-effect">DEFAULT</button>
									<button type="button"
										class="btn bg-orange btn-block btn-sm waves-effect">SMALL</button>
									<button type="button"
										class="btn bg-orange btn-block btn-xs waves-effect">EXTRA
										SMALL</button>
								</div>
								<div class="col-xs-6 col-sm-3 col-md-2 col-lg-2">
									<button type="button"
										class="btn bg-purple btn-block btn-lg waves-effect">LARGE</button>
									<button type="button"
										class="btn bg-purple btn-block waves-effect">DEFAULT</button>
									<button type="button"
										class="btn bg-purple btn-block btn-sm waves-effect">SMALL</button>
									<button type="button"
										class="btn bg-purple btn-block btn-xs waves-effect">EXTRA
										SMALL</button>
								</div>
							</div>
						</div>
			...
			<div class="row">
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					<div class="card">
						<div class="header">
							<h2>
								BLOCK BUTTONS <small>Create block level buttons</small>
							</h2>
							<ul class="header-dropdown m-r--5">
								<li class="dropdown"><a href="javascript:void(0);"
									class="dropdown-toggle" data-toggle="dropdown" role="button"
						...
						<div class="body">
							<div class="demo-button">
								<button type="button"
									class="btn btn-block btn-lg btn-default waves-effect">DEFAULT</button>
								<button type="button"
									class="btn btn-block btn-lg btn-primary waves-effect">PRIMARY</button>
								<button type="button"
									class="btn btn-block btn-lg btn-success waves-effect">SUCCESS</button>
								<button type="button"
									class="btn btn-block btn-lg btn-info waves-effect">INFO</button>
								<button type="button"
									class="btn btn-block btn-lg btn-warning waves-effect">WARNING</button>
								<button type="button"
									class="btn btn-block btn-lg btn-danger waves-effect">DANGER</button>
								<button type="button"
									class="btn btn-block btn-lg bg-red waves-effect">RED</button>
								<button type="button"
									class="btn btn-block btn-lg bg-pink waves-effect">PINK</button>
							</div>
						</div>
					</div>
				</div>
			...
			<div class="row">
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					<div class="card">
						<div class="header">
							<h2>
								DISABLED BUTTONS <small>Make buttons look unclickable by
									fading them back with opacity</small>
							</h2>
							<ul class="header-dropdown m-r--5">
								<li class="dropdown"><a href="javascript:void(0);"
									class="dropdown-toggle" data-toggle="dropdown" role="button"
			...
			<div class="row">
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					<div class="card">
						<div class="header">
							<h2>
								ICON BUTTONS <small>Make icon buttons</small>
							</h2>
							<ul class="header-dropdown m-r--5">
								<li class="dropdown"><a href="javascript:void(0);"
									class="dropdown-toggle" data-toggle="dropdown" role="button"
						...
						<div class="body">
							...
							<h2 class="card-inside-title">Large Circle</h2>
							<div class="icon-button-demo m-t-25">
								<button type="button"
							...
							<div class="icon-button-demo">
								...
								<button type="button"
									class="btn btn-info btn-circle-lg waves-effect waves-circle waves-float">
									<i class="material-icons">lock</i>
								</button>
								<button type="button"
									class="btn btn-warning btn-circle-lg waves-effect waves-circle waves-float">
									<i class="material-icons">perm_scan_wifi</i>
								</button>
								<button type="button"
								...
								<button type="button"
									class="btn bg-purple btn-circle-lg waves-effect waves-circle waves-float">
									<i class="material-icons">search</i>
								</button>
								<button type="button"
									class="btn bg-deep-purple btn-circle-lg waves-effect waves-circle waves-float">
									<i class="material-icons">settings</i>
								</button>
								<button type="button"
									class="btn bg-indigo btn-circle-lg waves-effect waves-circle waves-float">
									<i class="material-icons">trending_up</i>
								</button>
								<button type="button"
									class="btn bg-blue btn-circle-lg waves-effect waves-circle waves-float">
									<i class="material-icons">verified_user</i>
								</button>
								<button type="button"
									class="btn bg-light-blue btn-circle-lg waves-effect waves-circle waves-float">
									<i class="material-icons">mic</i>
								</button>
								<button type="button"
									class="btn bg-cyan btn-circle-lg waves-effect waves-circle waves-float">
									<i class="material-icons">call_missed_outgoing</i>
								</button>
								<button type="button"
								...
								<button type="button"
									class="btn bg-light-green btn-circle-lg waves-effect waves-circle waves-float">
									<i class="material-icons">chat</i>
								</button>
								<button type="button"
									class="btn bg-lime btn-circle-lg waves-effect waves-circle waves-float">
									<i class="material-icons">vpn_key</i>
								</button>
								<button type="button"
									class="btn bg-yellow btn-circle-lg waves-effect waves-circle waves-float">
									<i class="material-icons">content_cut</i>
								</button>
								<button type="button"
									class="btn bg-amber btn-circle-lg waves-effect waves-circle waves-float">
									<i class="material-icons">drafts</i>
								</button>
								<button type="button"
									class="btn bg-orange btn-circle-lg waves-effect waves-circle waves-float">
									<i class="material-icons">save</i>
								</button>
								<button type="button"
									class="btn bg-deep-orange btn-circle-lg waves-effect waves-circle waves-float">
									<i class="material-icons">weekend</i>
								</button>
								<button type="button"
									class="btn bg-brown btn-circle-lg waves-effect waves-circle waves-float">
									<i class="material-icons">access_alarm</i>
								</button>
								<button type="button"
									class="btn bg-grey btn-circle-lg waves-effect waves-circle waves-float">
									<i class="material-icons">location_searching</i>
								</button>
								<button type="button"
									class="btn bg-blue-grey btn-circle-lg waves-effect waves-circle waves-float">
									<i class="material-icons">merge_type</i>
								</button>
								<button type="button"
									class="btn bg-black btn-circle-lg waves-effect waves-circle waves-float waves-light">
									<i class="material-icons">publish</i>
								</button>
							</div>
						</div>
			...
			<div class="row">
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					<div class="card">
						<div class="header">
							<h2>
								ICON & TEXT BUTTONS <small>Make icon & text buttons</small>
							</h2>
							<ul class="header-dropdown m-r--5">
								<li class="dropdown"><a href="javascript:void(0);"
									class="dropdown-toggle" data-toggle="dropdown" role="button"
						...
						<div class="body">
							<div class="icon-and-text-button-demo">
								...
								<button type="button" class="btn btn-warning waves-effect">
									<i class="material-icons">perm_scan_wifi</i> <span>SCAN
										WIFI</span>
								</button>
								<button type="button" class="btn btn-danger waves-effect">
									<i class="material-icons">flight_takeoff</i> <span>TAKE
										OFF</span>
								</button>
								<button type="button" class="btn bg-red waves-effect">
								...
								<button type="button" class="btn bg-pink waves-effect">
									<i class="material-icons">report_problem</i> <span>REPORT
										ISSUE</span>
								</button>
								<button type="button" class="btn bg-purple waves-effect">
								...
								<button type="button" class="btn bg-indigo waves-effect">
									<i class="material-icons">trending_up</i> <span>TRENDING
										UP</span>
								</button>
								<button type="button" class="btn bg-blue waves-effect">
									<i class="material-icons">verified_user</i> <span>VERIFIED
										USER</span>
								</button>
								<button type="button" class="btn bg-light-blue waves-effect">
									<i class="material-icons">mic</i> <span>MIC</span>
								</button>
								<button type="button" class="btn bg-teal waves-effect">
									<i class="material-icons">forum</i> <span>FORUM</span>
								</button>
								<button type="button" class="btn bg-green waves-effect">
								...
								<button type="button" class="btn bg-lime waves-effect">
									<i class="material-icons">vpn_key</i> <span>VPN KEY</span>
								</button>
								<button type="button" class="btn bg-amber waves-effect">
									<i class="material-icons">drafts</i> <span>DRAFTS</span>
								</button>
								<button type="button" class="btn bg-orange waves-effect">
									<i class="material-icons">save</i> <span>SAVE</span>
								</button>
								<button type="button" class="btn bg-deep-orange waves-effect">
									<i class="material-icons">weekend</i> <span>WEEKEND</span>
								</button>
								<button type="button" class="btn bg-brown waves-effect">
									<i class="material-icons">access_alarm</i> <span>ALARM</span>
								</button>
							</div>
						</div>
					</div>
			...
			<div class="block-header">
				<h2>
					BUTTON GROUPS <small>Group a series of buttons together on
						a single line with the button group</small>
				</h2>
			</div>
			<div class="row">
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					<div class="card">
						<div class="header">
							<h2>
								BASIC EXAMPLE <small>Wrap a series of buttons with <code>.btn</code>
						...
						<div class="body">
							...
							<h2 class="card-inside-title">
								With Material Design Colors <small>You can use material
									design colors which examples are <code>.bg-pink</code> class
								</small>
							</h2>
							<div class="demo-button-groups">
								<div class="btn-group" role="group">
									<button type="button"
										class="btn bg-pink waves-effect waves-light">LEFT</button>
									<button type="button"
										class="btn bg-pink waves-effect waves-light">MIDDLE</button>
									<button type="button"
										class="btn bg-pink waves-effect waves-light">RIGHT</button>
								</div>
								<div class="btn-group" role="group">
								...
								<div class="btn-group" role="group">
									<button type="button"
										class="btn bg-purple waves-effect waves-light">LEFT</button>
									<button type="button"
										class="btn bg-purple waves-effect waves-light">MIDDLE</button>
									<button type="button"
										class="btn bg-purple waves-effect waves-light">RIGHT</button>
								</div>
								<div class="btn-group" role="group">
				...
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					<div class="card">
						<div class="header">
							<h2>
								BUTTON TOOLBAR <small>Combine sets of <code>&lt;div
										class=&quot;btn-group&quot;&gt;</code> into a <code>&lt;div
				...
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					<div class="card">
						<div class="header">
							<h2>
								SIZING <small>Instead of applying button sizing classes
									to every button in a group, just add <code>.btn-group-*</code>
									to each <code>.btn-group</code>, including when nesting
									multiple groups.
								</small>
							</h2>
							<ul class="header-dropdown m-r--5">
				...
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					<div class="card">
						<div class="header">
							<h2>
								NESTING <small>Place a <code>.btn-group</code> within
									another <code>.btn-group</code> when you want dropdown menus
						...
						<div class="body">
							<div class="demo-button-nesting">
								<div class="btn-group" role="group">
									...
									<div class="btn-group" role="group">
										<button type="button"
											class="btn btn-default waves-effect dropdown-toggle"
								...
								<div class="btn-group" role="group">
									...
									<div class="btn-group" role="group">
										<button type="button"
											class="btn btn-success waves-effect dropdown-toggle"
											data-toggle="dropdown" aria-haspopup="true"
											aria-expanded="false">
											Dropdown <span class="caret"></span>
										</button>
								...
								<div class="btn-group" role="group">
									...
									<div class="btn-group" role="group">
										<button type="button"
											class="btn btn-warning waves-effect dropdown-toggle"
											data-toggle="dropdown" aria-haspopup="true"
											aria-expanded="false">
											Dropdown <span class="caret"></span>
										</button>
								...
								<div class="btn-group" role="group">
									...
									<div class="btn-group" role="group">
										<button type="button"
											class="btn btn-danger waves-effect dropdown-toggle"
											data-toggle="dropdown" aria-haspopup="true"
											aria-expanded="false">
											Dropdown <span class="caret"></span>
										</button>
							...
							<div class="demo-button-nesting">
								<div class="btn-group" role="group">
									...
									<div class="btn-group" role="group">
										<button type="button"
											class="btn bg-pink waves-effect dropdown-toggle"
											data-toggle="dropdown" aria-haspopup="true"
											aria-expanded="false">
											Dropdown <span class="caret"></span>
										</button>
								...
								<div class="btn-group" role="group">
									...
									<div class="btn-group" role="group">
										<button type="button"
											class="btn bg-cyan waves-effect dropdown-toggle"
											data-toggle="dropdown" aria-haspopup="true"
											aria-expanded="false">
											Dropdown <span class="caret"></span>
										</button>
								...
								<div class="btn-group" role="group">
									...
									<div class="btn-group" role="group">
										<button type="button"
											class="btn bg-teal waves-effect dropdown-toggle"
											data-toggle="dropdown" aria-haspopup="true"
											aria-expanded="false">
											Dropdown <span class="caret"></span>
										</button>
								...
								<div class="btn-group" role="group">
									...
									<div class="btn-group" role="group">
										<button type="button"
											class="btn bg-orange waves-effect dropdown-toggle"
											data-toggle="dropdown" aria-haspopup="true"
											aria-expanded="false">
											Dropdown <span class="caret"></span>
										</button>
								...
								<div class="btn-group" role="group">
									...
									<div class="btn-group" role="group">
										<button type="button"
											class="btn bg-purple waves-effect dropdown-toggle"
											data-toggle="dropdown" aria-haspopup="true"
											aria-expanded="false">
											Dropdown <span class="caret"></span>
										</button>
								...
								<div class="btn-group" role="group">
									...
									<div class="btn-group" role="group">
										<button type="button"
											class="btn bg-blue-grey waves-effect dropdown-toggle"
											data-toggle="dropdown" aria-haspopup="true"
											aria-expanded="false">
											Dropdown <span class="caret"></span>
										</button>
				...
				<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
					<div class="card">
						<div class="header">
							<h2>
								VERTICAL VARIATION <small>Make a set of buttons appear
									vertically stacked rather than horizontally.</small>
							</h2>
							<ul class="header-dropdown m-r--5">
								<li class="dropdown"><a href="javascript:void(0);"
									class="dropdown-toggle" data-toggle="dropdown" role="button"
				...
				<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
					<div class="card">
						<div class="header">
							<h2>
								JUSTIFIED BUTTON GROUPS <small>Make a group of buttons
									stretch at equal sizes to span the entire width of its parent.
									Also works with button dropdowns within the button group.</small>
							</h2>
							<ul class="header-dropdown m-r--5">
								<li class="dropdown"><a href="javascript:void(0);"
									class="dropdown-toggle" data-toggle="dropdown" role="button"
						...
						<div class="body">
							<div class="btn-group btn-group-justified" role="group"
								...
								<a href="javascript:void(0);" class="btn bg-pink waves-effect"
									role="button">LEFT</a> <a href="javascript:void(0);"
									class="btn bg-pink waves-effect" role="button">MIDDLE</a> <a
									href="javascript:void(0);" class="btn bg-pink waves-effect"
									role="button">RIGHT</a>
							</div>

							<div class="btn-group btn-group-justified m-t-25 m-b-15"
								role="group"
								aria-label="Justified button group with nested dropdown">
								<a href="javascript:void(0);" class="btn bg-pink waves-effect"
									role="button">LEFT</a> <a href="javascript:void(0);"
									class="btn bg-pink waves-effect" role="button">MIDDLE</a>
								<div class="btn-group" role="group">
									<a href="javascript:void(0);"
										class="btn bg-pink dropdown-toggle" data-toggle="dropdown"
			...
			<div class="block-header">
				<h2>
					BUTTON DROPDOWNS <small>Use any button to trigger a
						dropdown menu by placing it within a .btn-group and providing the
						proper menu markup.</small>
				</h2>
			</div>
			<div class="row">
				<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
					<div class="card">
						<div class="header">
							<h2>
								SINGLE BUTTON DROPDOWNS <small>Turn a button into a
									dropdown toggle with some basic markup changes.</small>
							</h2>
							<ul class="header-dropdown m-r--5">
								<li class="dropdown"><a href="javascript:void(0);"
									class="dropdown-toggle" data-toggle="dropdown" role="button"
						...
						<div class="body">
							...
							<div class="demo-single-button-dropdowns">
								...
								<div class="btn-group">
									<button type="button" class="btn bg-orange dropdown-toggle"
										data-toggle="dropdown" aria-haspopup="true"
										aria-expanded="false">
								...
								<div class="btn-group">
									<button type="button" class="btn bg-purple dropdown-toggle"
										data-toggle="dropdown" aria-haspopup="true"
										aria-expanded="false">
				...
				<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
					<div class="card">
						<div class="header">
							<h2>
								SPLITE BUTTON DROPDOWNS <small>Similarly, create split
									button dropdowns with the same markup changes, only with a
									separate button.</small>
							</h2>
							<ul class="header-dropdown m-r--5">
								<li class="dropdown"><a href="javascript:void(0);"
									class="dropdown-toggle" data-toggle="dropdown" role="button"
			...
			<div class="row clearfix">
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					<div class="card">
						<div class="header">
							<h2>
								DROPUP VARIATION <small>Trigger dropdown menus above
									elements by adding <code>.dropup</code> to the parent.
								</small>
							</h2>
							<ul class="header-dropdown m-r--5">
								<li class="dropdown"><a href="javascript:void(0);"
						...
						<div class="body">
							<div class="demo-dropup">
								<div class="btn-group dropup">
									<button type="button" class="btn btn-default waves-effect">DEFAULT
										DROPUP</button>
									<button type="button"
										class="btn btn-default waves-effect dropdown-toggle"
										data-toggle="dropdown" aria-haspopup="true"
								...
								<div class="btn-group dropup">
									<button type="button" class="btn btn-primary waves-effect">PRIMARY
										DROPUP</button>
									<button type="button"
										class="btn btn-primary waves-effect dropdown-toggle"
										data-toggle="dropdown" aria-haspopup="true"
								...
								<div class="btn-group dropup">
									<button type="button" class="btn btn-success waves-effect">SUCCESS
										DROPUP</button>
									<button type="button"
										class="btn btn-success waves-effect dropdown-toggle"
										data-toggle="dropdown" aria-haspopup="true"
								...
								<div class="btn-group dropup">
									<button type="button" class="btn btn-info waves-effect">INFO
										DROPUP</button>
									<button type="button"
										class="btn btn-info waves-effect dropdown-toggle"
										data-toggle="dropdown" aria-haspopup="true"
								...
								<div class="btn-group dropup">
									<button type="button" class="btn btn-warning waves-effect">WARNING
										DROPUP</button>
									<button type="button"
										class="btn btn-warning waves-effect dropdown-toggle"
										data-toggle="dropdown" aria-haspopup="true"
								...
								<div class="btn-group dropup">
									<button type="button" class="btn btn-danger waves-effect">DANGER
										DROPUP</button>
									<button type="button"
										class="btn btn-danger waves-effect dropdown-toggle"
										data-toggle="dropdown" aria-haspopup="true"
							...
							<div class="demo-dropup">
								<div class="btn-group dropup">
									<button type="button" class="btn bg-pink waves-effect">PINK
										DROPUP</button>
									<button type="button"
										class="btn bg-pink waves-effect dropdown-toggle"
										data-toggle="dropdown" aria-haspopup="true"
								...
								<div class="btn-group dropup">
									<button type="button" class="btn bg-cyan waves-effect">CYAN
										DROPUP</button>
									<button type="button"
										class="btn bg-cyan waves-effect dropdown-toggle"
										data-toggle="dropdown" aria-haspopup="true"
								...
								<div class="btn-group dropup">
									<button type="button" class="btn bg-teal waves-effect">TEAL
										DROPUP</button>
									<button type="button"
										class="btn bg-teal waves-effect dropdown-toggle"
										data-toggle="dropdown" aria-haspopup="true"
								...
								<div class="btn-group dropup">
									<button type="button" class="btn bg-orange waves-effect">ORANGE
										DROPUP</button>
									<button type="button"
										class="btn bg-orange waves-effect dropdown-toggle"
										data-toggle="dropdown" aria-haspopup="true"
								...
								<div class="btn-group dropup">
									<button type="button" class="btn bg-purple waves-effect">PURPLE
										DROPUP</button>
									<button type="button"
										class="btn bg-purple waves-effect dropdown-toggle"
										data-toggle="dropdown" aria-haspopup="true"
								...
								<div class="btn-group dropup">
									<button type="button"
										class="btn bg-blue-grey waves-effect waves-light">BLUE
										GREY DROPUP</button>
									<button type="button"
										class="btn bg-blue-grey waves-effect waves-light dropdown-toggle"
										data-toggle="dropdown" aria-haspopup="true"
										aria-expanded="false">
										<span class="caret"></span> <span class="sr-only">Toggle
											Dropdown</span>
