					...
					<li class="active"><a href="javascript:void(0);"
						...
						<ul class="ml-menu">
							...
							<li><a href="../../pages/ui/sortable-nestable.html">Sortable
									& Nestable</a></li>
							<li class="active"><a href="../../pages/ui/tabs.html">Tabs</a>
							</li>
			...
			<div class="row">
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					<div class="card">
						<div class="header">
							<h2>
								EXAMPLE TAB <small>Add quick, dynamic tab functionality
									to transition through panes of local content</small>
							</h2>
						...
						<div class="body">
							...
							<div class="tab-content">
								<div role="tabpanel" class="tab-pane fade in active" id="home">
									<b>Home Content</b>
									<p>Lorem ipsum dolor sit amet, ut duo atqui exerci dicunt,
										ius impedit mediocritatem an. Pri ut tation electram
										moderatius. Per te suavitate democritum. Duis nemore probatus
										ne quo, ad liber essent aliquid pro. Et eos nusquam accumsan,
										vide mentitum fabellas ne est, eu munere gubergren sadipscing
										mel.</p>
								</div>
						...
						<div class="body">
							...
							<ul class="nav nav-tabs tab-nav-right" role="tablist">
								<li role="presentation" class="active"><a
									href="#home_only_icon_title" data-toggle="tab"> <i
										class="material-icons">home</i>
								</a></li>
								<li role="presentation"><a href="#profile_only_icon_title"
									data-toggle="tab"> <i class="material-icons">face</i>
								</a></li>
								<li role="presentation"><a href="#messages_only_icon_title"
									data-toggle="tab"> <i class="material-icons">email</i>
								</a></li>
								<li role="presentation"><a href="#settings_only_icon_title"
									data-toggle="tab"> <i class="material-icons">settings</i>
								</a></li>
							</ul>
					...
					<div class="card">
						...
						<div class="body">
							...
							<ul class="nav nav-tabs" role="tablist">
								...
								<li role="presentation"><a href="#messages_with_icon_title"
									data-toggle="tab"> <i class="material-icons">email</i>
										MESSAGES
								</a></li>
								<li role="presentation"><a href="#settings_with_icon_title"
									data-toggle="tab"> <i class="material-icons">settings</i>
										SETTINGS
								</a></li>
							</ul>
			...
			<div class="row clearfix">
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					<div class="card">
						<div class="header">
							<h2>
								TABS WITH MATERIAL DESIGN COLORS <small>You can use
									Material Design Colors which examples are <b>.tab-col-red,
										.tab-col-pink</b> class.
								</small>
							</h2>
							<ul class="header-dropdown m-r--5">
								<li class="dropdown"><a href="javascript:void(0);"
							...
							<div class="row clearfix">
								<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
									<ul class="nav nav-tabs tab-col-pink" role="tablist">
										<li role="presentation" class="active"><a
											href="#home_md_col_1" data-toggle="tab">HOME</a></li>
										<li role="presentation"><a href="#profile_md_col_1"
											data-toggle="tab">PROFILE</a></li>
										<li role="presentation"><a href="#messages_md_col_1"
											data-toggle="tab">MESSAGES</a></li>
										<li role="presentation"><a href="#settings_md_col_1"
											data-toggle="tab">SETTINGS</a></li>
									</ul>
								</div>
								<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
									<ul class="nav nav-tabs tab-col-deep-orange" role="tablist">
										<li role="presentation" class="active"><a
											href="#home_md_col_2" data-toggle="tab">HOME</a></li>
										<li role="presentation"><a href="#profile_md_col_2"
											data-toggle="tab">PROFILE</a></li>
										<li role="presentation"><a href="#messages_md_col_2"
											data-toggle="tab">MESSAGES</a></li>
										<li role="presentation"><a href="#settings_md_col_2"
											data-toggle="tab">SETTINGS</a></li>
									</ul>
								</div>
								<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
									<ul class="nav nav-tabs tab-col-teal" role="tablist">
										<li role="presentation" class="active"><a
											href="#home_md_col_3" data-toggle="tab">HOME</a></li>
										<li role="presentation"><a href="#profile_md_col_3"
											data-toggle="tab">PROFILE</a></li>
										<li role="presentation"><a href="#messages_md_col_3"
											data-toggle="tab">MESSAGES</a></li>
										<li role="presentation"><a href="#settings_md_col_3"
											data-toggle="tab">SETTINGS</a></li>
									</ul>
								</div>
								<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
									<ul class="nav nav-tabs tab-col-orange" role="tablist">
										<li role="presentation" class="active"><a
											href="#home_md_col_4" data-toggle="tab">HOME</a></li>
										<li role="presentation"><a href="#profile_md_col_4"
											data-toggle="tab">PROFILE</a></li>
										<li role="presentation"><a href="#messages_md_col_4"
											data-toggle="tab">MESSAGES</a></li>
										<li role="presentation"><a href="#settings_md_col_4"
											data-toggle="tab">SETTINGS</a></li>
									</ul>
								</div>
								<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
									<ul class="nav nav-tabs tab-col-purple" role="tablist">
										<li role="presentation" class="active"><a
											href="#home_md_col_5" data-toggle="tab">HOME</a></li>
										<li role="presentation"><a href="#profile_md_col_5"
											data-toggle="tab">PROFILE</a></li>
										<li role="presentation"><a href="#messages_md_col_5"
											data-toggle="tab">MESSAGES</a></li>
										<li role="presentation"><a href="#settings_md_col_5"
											data-toggle="tab">SETTINGS</a></li>
									</ul>
								</div>
								<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
									<ul class="nav nav-tabs tab-col-blue-grey" role="tablist">
										<li role="presentation" class="active"><a
											href="#home_md_col_6" data-toggle="tab">HOME</a></li>
										<li role="presentation"><a href="#profile_md_col_6"
											data-toggle="tab">PROFILE</a></li>
										<li role="presentation"><a href="#messages_md_col_6"
											data-toggle="tab">MESSAGES</a></li>
										<li role="presentation"><a href="#settings_md_col_6"
											data-toggle="tab">SETTINGS</a></li>
									</ul>
								</div>
							</div>
			...
			<div class="row clearfix">
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					<div class="card">
						<div class="header">
							<h2>
								TABS WITH CUSTOM ANIMATIONS <small>You can use different
									animation class. We used Animation.css which link is <a
						...
						<div class="body">
							<div class="row clearfix">
								<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
									...
									<ul class="nav nav-tabs tab-nav-right" role="tablist">
										<li role="presentation" class="active"><a
											href="#home_animation_1" data-toggle="tab">HOME</a></li>
										<li role="presentation"><a href="#profile_animation_1"
											data-toggle="tab">PROFILE</a></li>
										<li role="presentation"><a href="#messages_animation_1"
											data-toggle="tab">MESSAGES</a></li>
										<li role="presentation"><a href="#settings_animation_1"
											data-toggle="tab">SETTINGS</a></li>
									</ul>
									...
									<div class="tab-content">
										<div role="tabpanel" class="tab-pane animated flipInX active"
											id="home_animation_1">
											<b>Home Content</b>
											<p>Lorem ipsum dolor sit amet, ut duo atqui exerci
												dicunt, ius impedit mediocritatem an. Pri ut tation electram
												moderatius. Per te suavitate democritum. Duis nemore
												probatus ne quo, ad liber essent aliquid pro. Et eos nusquam
												accumsan, vide mentitum fabellas ne est, eu munere gubergren
												sadipscing mel.</p>
										</div>
								...
								<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
									...
									<ul class="nav nav-tabs tab-nav-right" role="tablist">
										<li role="presentation" class="active"><a
											href="#home_animation_2" data-toggle="tab">HOME</a></li>
										<li role="presentation"><a href="#profile_animation_2"
											data-toggle="tab">PROFILE</a></li>
										<li role="presentation"><a href="#messages_animation_2"
											data-toggle="tab">MESSAGES</a></li>
										<li role="presentation"><a href="#settings_animation_2"
											data-toggle="tab">SETTINGS</a></li>
									</ul>
