...
<meta
	...
	name="viewport">
<title>Sortable & Nestable | Bootstrap Based Admin Template -
					...
					<li class="active"><a href="javascript:void(0);"
						...
						<ul class="ml-menu">
							...
							<li><a href="../../pages/ui/range-sliders.html">Range
									Sliders</a></li>
							<li class="active"><a
								href="../../pages/ui/sortable-nestable.html">Sortable &
									Nestable</a></li>
	...
	<section class="content">
		<div class="container-fluid">
			<div class="block-header">
				<h2>
					SORTABLE & NESTABLE <small>Taken by <a
			...
			<div class="row clearfix">
				...
				<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
					<div class="card">
						<div class="header">
							<h2>
								DEFAULT EXAMPLE <small>Drag & drop hierarchical list
									with mouse and touch compatibility</small>
							</h2>
						...
						<div class="body">
							...
							<textarea cols="30" rows="3" class="form-control no-resize"
								readonly>[{"id":1},{"id":2,"children":[{"id":3},{"id":4},{"id":5,"children":[{"id":6},{"id":7},{"id":8}]},{"id":9},{"id":10}]},{"id":11},{"id":12}]</textarea>
						</div>
					</div>
				</div>
				<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
