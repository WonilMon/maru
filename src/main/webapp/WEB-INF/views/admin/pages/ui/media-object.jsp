...
<meta
	...
	name="viewport">
<title>Media Object | Bootstrap Based Admin Template - Material
	Design</title>
<!-- Favicon-->
				...
				<ul class="list">
					...
					<li class="active"><a href="javascript:void(0);"
						...
						<ul class="ml-menu">
							...
							<li class="active"><a
								href="../../pages/ui/media-object.html">Media Object</a></li>
			...
			<div class="row clearfix">
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					<div class="card">
						<div class="header">
							<h2>
								DEFAULT MEDIA <small>The default media displays a media
							...
							<div class="media">
								<div class="media-left">
									<a href="javascript:void(0);"> <img class="media-object"
										src="http://placehold.it/64x64" width="64" height="64">
									</a>
								</div>
			...
			<div class="row clearfix">
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					<div class="card">
						<div class="header">
							<h2>
								MEDIA ALIGNMENT <small>The images or other media can be
									aligned top, middle, or bottom. The default is top aligned.</small>
							</h2>
							<ul class="header-dropdown m-r--5">
								<li class="dropdown"><a href="javascript:void(0);"
									class="dropdown-toggle" data-toggle="dropdown" role="button"
