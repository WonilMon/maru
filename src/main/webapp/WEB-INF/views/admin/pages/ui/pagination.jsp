...
<meta
	...
	name="viewport">
<title>Pagination | Bootstrap Based Admin Template - Material
	Design</title>
<!-- Favicon-->
				...
				<ul class="list">
					...
					<li class="active"><a href="javascript:void(0);"
						...
						<ul class="ml-menu">
							...
							<li class="active"><a href="../../pages/ui/pagination.html">Pagination</a>
							</li>
			...
			<div class="row clearfix">
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					<div class="card">
						<div class="header">
							<h2>
								DEFAULT PAGINATION <small>Simple pagination inspired by
									Rdio, great for apps and search results. The large block is
									hard to miss, easily scalable, and provides large click areas.</small>
							</h2>
					...
					<div class="card">
						<div class="header">
							<h2>
								DISABLED AND ACTIVE STATES <small>Links are customizable
									for different circumstances. Use <code>.disabled</code> for
									unclickable links and <code>.active</code> to indicate the
									current page.
								</small>
							</h2>
							<ul class="header-dropdown m-r--5">
					...
					<div class="card">
						<div class="header">
							<h2>
								SIZING <small>Fancy larger or smaller pagination? Add <code>.pagination-lg</code>
			...
			<div class="row clearfix">
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					<div class="card">
						<div class="header">
							<h2>
								DEFAULT EXAMPLE <small>By default, the pager centers
									links.</small>
							</h2>
							<ul class="header-dropdown m-r--5">
								<li class="dropdown"><a href="javascript:void(0);"
		...
		<div class="row clearfix">
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				<div class="card">
					<div class="header">
						<h2>
							ALIGNED LINKS <small>Alternatively, you can align each
								link to the sides:</small>
						</h2>
						<ul class="header-dropdown m-r--5">
							<li class="dropdown"><a href="javascript:void(0);"
								class="dropdown-toggle" data-toggle="dropdown" role="button"
						...
						<nav>
							<ul class="pager">
								<li class="previous"><a href="javascript:void(0);"
									class="waves-effect"><span aria-hidden="true">&larr;</span>
										Older</a></li>
								<li class="next"><a href="javascript:void(0);"
									class="waves-effect">Newer <span aria-hidden="true">&rarr;</span></a>
								</li>
							</ul>
						</nav>
					</div>
		...
		<div class="row clearfix">
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				<div class="card">
					<div class="header">
						<h2>
							OPTIONAL DISABLED STATE <small>Pager links also use the
								general <code>.disabled</code> utility class from the
								pagination.
							</small>
						</h2>
						<ul class="header-dropdown m-r--5">
					...
					<div class="body">
						<nav>
							<ul class="pager">
								...
								<li class="next"><a href="javascript:void(0);"
									class="waves-effect"> Newer <span aria-hidden="true">&rarr;</span>
								</a></li>
							</ul>
						</nav>
					</div>
