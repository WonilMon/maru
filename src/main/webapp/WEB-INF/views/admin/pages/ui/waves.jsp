					...
					<li class="active"><a href="javascript:void(0);"
						...
						<ul class="ml-menu">
							...
							<li><a href="../../pages/ui/tooltips-popovers.html">Tooltips
									& Popovers</a></li>
							<li class="active"><a href="../../pages/ui/waves.html">Waves</a>
							</li>
						</ul></li>
					<li><a href="javascript:void(0);" class="menu-toggle"> <i
	...
	<section class="content">
		<div class="container-fluid">
			<div class="block-header">
				<h2>
					WAVES <small>Click effect inspired by Google's Material
						Design. Taken by <a href="http://fian.my.id/Waves/"
						target="_blank">fian.my.id/Waves</a>
					</small>
				</h2>
			</div>
			<div class="row clearfix">
				...
				<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
					<div class="card">
						...
						<div class="body">
							<ul class="list-group">
								<li class="list-group-item clearfix">Default <a
									href="javascript:void(0);"
									class="btn btn-default waves-effect pull-right">CLICK ME</a>
								</li>
