				...
				<ul class="list">
					...
					<li class="active"><a href="javascript:void(0);"
						...
						<ul class="ml-menu">
							...
							<li class="active"><a href="../../pages/ui/labels.html">Labels</a>
							</li>
				...
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					<div class="card">
						...
						<div class="body">
							...
							<hr>
							<h1>
								Example heading <span class="label label-danger">New</span>
							</h1>
							<h2>
								Example heading <span class="label label-warning">New</span>
							</h2>
							<h3>
								Example heading <span class="label label-info">New</span>
							</h3>
							<h4>
								Example heading <span class="label label-success">New</span>
							</h4>
							<h5>
			...
			<div class="row clearfix">
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					<div class="card">
						<div class="header">
							<h2>
								LABELS WITH MATERIAL DESIGN COLORS <small>You can use
									material design color which examples are <code>.bg-pink,
										bg-red</code> class
								</small>
							</h2>
							<ul class="header-dropdown m-r--5">
						...
						<div class="body">
							<span class="label bg-red">Red</span> <span class="label bg-pink">Pink</span>
							<span class="label bg-purple">Purple</span> <span
								class="label bg-deep-purple">Deep Purple</span> <span
								class="label bg-indigo">Indigo</span> <span
								class="label bg-blue">Blue</span> <span
								class="label bg-light-blue">Light Blue</span> <span
								class="label bg-cyan">Cyan</span> <span class="label bg-teal">Teal</span>
							<span class="label bg-green">Green</span> <span
								class="label bg-light-green">Light Green</span> <span
								class="label bg-lime">Lime</span> <span class="label bg-yellow">Yellow</span>
							<span class="label bg-amber">Amber</span> <span
								class="label bg-orange">Orange</span> <span
								class="label bg-deep-orange">Deep Orange</span> <span
								class="label bg-brown">Brown</span> <span class="label bg-grey">Grey</span>
							<span class="label bg-blue-grey">Blue Grey</span> <span
								class="label bg-black">Black</span>
						</div>
					</div>
				</div>
			</div>
