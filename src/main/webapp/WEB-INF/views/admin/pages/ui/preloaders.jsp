...
<meta
	...
	name="viewport">
<title>Preloaders | Bootstrap Based Admin Template - Material
	Design</title>
<!-- Favicon-->
				...
				<ul class="list">
					...
					<li class="active"><a href="javascript:void(0);"
						...
						<ul class="ml-menu">
							...
							<li class="active"><a href="../../pages/ui/preloaders.html">Preloaders</a>
							</li>
						...
						<div class="header">
							<h2>
								WITH MATERIAL DESIGN COLORS <small>You can use the
									material design colors which examples are <code>.pl-red,
										.pl-pink</code> class.
								</small>
							</h2>
							<ul class="header-dropdown m-r--5">
