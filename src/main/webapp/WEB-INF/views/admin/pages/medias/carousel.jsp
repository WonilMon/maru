...
<meta
	...
	name="viewport">
<title>Carousel | Bootstrap Based Admin Template - Material
	Design</title>
					...
					<li class="active"><a href="javascript:void(0);"
						...
						<ul class="ml-menu">
							<li><a href="../../pages/medias/image-gallery.html">Image
									Gallery</a></li>
							<li class="active"><a
								href="../../pages/medias/carousel.html">Carousel</a></li>
						</ul></li>
					<li><a href="javascript:void(0);" class="menu-toggle"> <i
	...
	<section class="content">
		<div class="container-fluid">
			<div class="block-header">
				<h2>
					CAROUSEL <small>All images taken from <a
			...
			<div class="row clearfix">
				...
				<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
					<div class="card">
						...
						<div class="body">
							<div id="carousel-example-generic_2" class="carousel slide"
								data-ride="carousel">
								<!-- Indicators -->
								<ol class="carousel-indicators">
								...
								<!-- Controls -->
								<a class="left carousel-control"
									href="#carousel-example-generic_2" role="button"
									data-slide="prev"> <span
									class="glyphicon glyphicon-chevron-left" aria-hidden="true"></span>
									<span class="sr-only">Previous</span>
								</a> <a class="right carousel-control"
