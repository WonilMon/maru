...
<meta
	...
	name="viewport">
<title>Changelogs | Bootstrap Based Admin Template - Material
	Design</title>
		...
		<aside id="leftsidebar" class="sidebar">
			...
			<div class="menu">
				<ul class="list">
					...
					<li class="active"><a href="changelogs.html"> <i
			...
			<div class="row clearfix">
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					<div class="card">
						<div class="header">
							<h2>
								v1.0.7 <small>30th October 2018</small>
							</h2>
						</div>
						<div class="body">
							...
							<p>
								- <a href="https://github.com/uxsolutions/bootstrap-datepicker"
									target="_blank">Bootstrap Datepicker</a> plugin integrated.
							</p>
						</div>
					</div>
				</div>
			...
			<div class="row clearfix">
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					<div class="card">
						<div class="header">
							<h2>
								v1.0.5 <small>27th June 2017</small>
							</h2>
						</div>
						<div class="body">
							<p>- Fixed bugs</p>
			...
			<div class="row clearfix">
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					<div class="card">
						<div class="header">
							<h2>
								v1.0.4 <small>15th November 2016</small>
							</h2>
						</div>
						<div class="body">
			...
			<div class="row clearfix">
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					<div class="card">
						<div class="header">
							<h2>
								v1.0.3 <small>19th August 2016</small>
							</h2>
						</div>
						<div class="body">
			...
			<div class="row clearfix">
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					<div class="card">
						<div class="header">
							<h2>
								v1.0.2 <small>18th August 2016</small>
							</h2>
						</div>
						<div class="body">
							<p>- Fixed IE 10</p>
			...
			<div class="row clearfix">
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					<div class="card">
						<div class="header">
							<h2>
								v1.0.1 <small>17th August 2016</small>
							</h2>
						</div>
						<div class="body">
							<p>- Fixed IE 10&11 support issues</p>
							<p>- Add browser support class to html (You can write run
								only specified browsers)</p>
						</div>
					</div>
				</div>
			</div>
			<div class="row clearfix">
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					<div class="card">
						...
						<div class="body">Version 1.0.0 released on 16th August
							2016.</div>
					</div>
				</div>
			</div>
