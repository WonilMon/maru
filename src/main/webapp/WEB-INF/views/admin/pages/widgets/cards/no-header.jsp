...
<meta
	...
	name="viewport">
<title>No Header Card | Bootstrap Based Admin Template -
		...
		<div class="container-fluid">
			<div class="navbar-header">
				<a href="javascript:void(0);" class="navbar-toggle collapsed"
					...
					href="../../../index.html">ADMINBSB - MATERIAL DESIGN</a>
			</div>
			...
			<div class="menu">
				<ul class="list">
					...
					<li class="active"><a href="javascript:void(0);"
						class="menu-toggle"> <i class="material-icons">widgets</i> <span>Widgets</span>
					</a>
						<ul class="ml-menu">
							<li class="active"><a href="javascript:void(0);"
								class="menu-toggle"> <span>Cards</span>
							</a>
								<ul class="ml-menu">
									...
									<li class="active"><a
										href="../../../pages/widgets/cards/no-header.html">No
											Header</a></li>
								</ul></li>
							<li><a href="javascript:void(0);" class="menu-toggle"> <span>Infobox</span>
								...
								<ul class="ml-menu">
									<li><a
										href="../../../pages/widgets/infobox/infobox-1.html">Infobox-1</a>
									</li>
									<li><a
										href="../../../pages/widgets/infobox/infobox-2.html">Infobox-2</a>
									</li>
									<li><a
										href="../../../pages/widgets/infobox/infobox-3.html">Infobox-3</a>
									</li>
									<li><a
										href="../../../pages/widgets/infobox/infobox-4.html">Infobox-4</a>
									</li>
									<li><a
										href="../../../pages/widgets/infobox/infobox-5.html">Infobox-5</a>
									</li>
								</ul></li>
						</ul></li>
					<li><a href="javascript:void(0);" class="menu-toggle"> <i
						...
						<ul class="ml-menu">
							...
							<li><a href="../../../pages/ui/list-group.html">List
									Group</a></li>
					...
					<li><a href="javascript:void(0);" class="menu-toggle"> <i
						...
						<ul class="ml-menu">
							<li><a href="../../../pages/forms/basic-form-elements.html">Basic
									Form Elements</a></li>
							<li><a
								href="../../../pages/forms/advanced-form-elements.html">Advanced
									Form Elements</a></li>
							...
							<li><a href="../../../pages/forms/form-wizard.html">Form
									Wizard</a></li>
							<li><a href="../../../pages/forms/editors.html">Editors</a>
							</li>
						</ul></li>
					<li><a href="javascript:void(0);" class="menu-toggle"> <i
					...
					<li><a href="javascript:void(0);" class="menu-toggle"> <i
						...
						<ul class="ml-menu">
							...
							<li><a href="../../../pages/charts/chartjs.html">ChartJS</a>
							</li>
					...
					<li><a href="javascript:void(0);" class="menu-toggle"> <i
						...
						<ul class="ml-menu">
							...
							<li><a href="../../../pages/examples/sign-in.html">Sign
									In</a></li>
							<li><a href="../../../pages/examples/sign-up.html">Sign
									Up</a></li>
							<li><a href="../../../pages/examples/forgot-password.html">Forgot
									Password</a></li>
							<li><a href="../../../pages/examples/blank.html">Blank
									Page</a></li>
							<li><a href="../../../pages/examples/404.html">404 - Not
									Found</a></li>
							<li><a href="../../../pages/examples/500.html">500 -
									Server Error</a></li>
						</ul></li>
					<li><a href="javascript:void(0);" class="menu-toggle"> <i
						...
						<ul class="ml-menu">
							<li><a href="../../../pages/maps/google.html">Google Map</a>
							</li>
							<li><a href="../../../pages/maps/yandex.html">YandexMap</a>
							</li>
		...
		<div class="container-fluid">
			...
			<div class="row">
				<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
					<div class="card">
						<div class="body bg-red">Quis pharetra a pharetra fames
							blandit. Risus faucibus velit Risus imperdiet mattis neque
							volutpat, etiam lacinia netus dictum magnis per facilisi
							sociosqu. Volutpat. Ridiculus nostra.</div>
					</div>
				</div>
				<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
					<div class="card">
						<div class="body bg-cyan">Quis pharetra a pharetra fames
							blandit. Risus faucibus velit Risus imperdiet mattis neque
							volutpat, etiam lacinia netus dictum magnis per facilisi
							sociosqu. Volutpat. Ridiculus nostra.</div>
					</div>
				...
				<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
					<div class="card">
						<div class="body bg-green">Quis pharetra a pharetra fames
							blandit. Risus faucibus velit Risus imperdiet mattis neque
							volutpat, etiam lacinia netus dictum magnis per facilisi
							sociosqu. Volutpat. Ridiculus nostra.</div>
					</div>
			...
			<div class="row">
				<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
					<div class="card">
						<div class="body bg-orange">Quis pharetra a pharetra fames
							blandit. Risus faucibus velit Risus imperdiet mattis neque
							volutpat, etiam lacinia netus dictum magnis per facilisi
							sociosqu. Volutpat. Ridiculus nostra.</div>
					</div>
				...
				<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
					<div class="card">
						<div class="body bg-blue-grey">Quis pharetra a pharetra
							fames blandit. Risus faucibus velit Risus imperdiet mattis neque
							volutpat, etiam lacinia netus dictum magnis per facilisi
							sociosqu. Volutpat. Ridiculus nostra.</div>
					</div>
				</div>
				<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
					<div class="card">
						<div class="body  bg-pink">Quis pharetra a pharetra fames
							blandit. Risus faucibus velit Risus imperdiet mattis neque
							volutpat, etiam lacinia netus dictum magnis per facilisi
							sociosqu. Volutpat. Ridiculus nostra.</div>
					</div>
			...
			<div class="row">
				<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
					<div class="card">
						<div class="body bg-light-blue">Quis pharetra a pharetra
							fames blandit. Risus faucibus velit Risus imperdiet mattis neque
							volutpat, etiam lacinia netus dictum magnis per facilisi
							sociosqu. Volutpat. Ridiculus nostra.</div>
					</div>
				...
				<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
					<div class="card">
						<div class="body bg-light-green">Quis pharetra a pharetra
							fames blandit. Risus faucibus velit Risus imperdiet mattis neque
							volutpat, etiam lacinia netus dictum magnis per facilisi
							sociosqu. Volutpat. Ridiculus nostra.</div>
					</div>
				...
				<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
					<div class="card">
						<div class="body bg-amber">Quis pharetra a pharetra fames
							blandit. Risus faucibus velit Risus imperdiet mattis neque
							volutpat, etiam lacinia netus dictum magnis per facilisi
							sociosqu. Volutpat. Ridiculus nostra.</div>
					</div>
