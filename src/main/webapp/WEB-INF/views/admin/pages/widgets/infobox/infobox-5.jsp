...
<meta
	...
	name="viewport">
<title>Infobox - 5 | Bootstrap Based Admin Template - Material
	Design</title>
<!-- Favicon-->
				...
				<ul class="list">
					...
					<li class="active"><a href="javascript:void(0);"
						...
						<ul class="ml-menu">
							...
							<li class="active"><a href="javascript:void(0);"
								class="menu-toggle"> <span>Infobox</span>
							</a>
								<ul class="ml-menu">
									<li><a
	...
	<section class="content">
		<div class="container-fluid">
			...
			<div class="block-header">
				<h2>
					COUNTER ANIMATION <small>Taken from <a
						href="https://github.com/mhuggins/jquery-countTo" target="_blank">github.com/mhuggins/jquery-countTo</a></small>
				</h2>
			</div>
			<div class="row">
					...
					<div class="info-box-4">
						...
						<div class="content">
							...
							<div class="number count-to" data-from="0" data-to="125"
								data-speed="1000" data-fresh-interval="20">125</div>
						</div>
					</div>
				</div>
				<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
					...
					<div class="info-box-4">
						...
						<div class="content">
							...
							<div class="number count-to" data-from="0" data-to="1432"
								data-speed="1500" data-fresh-interval="20"></div>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="row">
				...
				<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
					<div class="info-box-4">
						<div class="icon">
							<div class="chart chart-pie" data-chartcolor="orange">30,
								35, 25, 8</div>
						</div>
						<div class="content">
				...
				<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
					<div class="info-box-4">
						<div class="icon">
							<div class="chart chart-pie" data-chartcolor="deepOrange">30,
								35, 25, 10</div>
						</div>
						<div class="content">
							<div class="text">USAGE</div>
